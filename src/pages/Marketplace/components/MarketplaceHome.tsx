...
const MarketplaceHome: React.FC = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row rounded-b-[10px] overflow-hidden leading-none bg-[url('src/shared/assets/images/Marketplace.png')]">
            <div className="flex flex-col pt-[88px] md:pt-[120px] lg:pt-[132px] xl:pt-[184px] 2xl:pt-[206px] px-[20px] md:pl-[40px] md:pr-0 lg:pl-[60px] pb-0 md:pb-[52px] lg:pb-[46px] xl:pb-[62px] bg-[#E9EBEE] w-full">
                ...
                <div className="flex gap-[14px] w-full pb-[224px] md:pb-0">
                    <a
                        className="flex justify-center items-center gap-[8px] bg-[#344E74] hover:bg-[#506fa1] active:bg-white border-1 border-[#344E74] active:text-[#344E74] text-white py-[8px] md:py-[10.5px] lg:py-[18px] px-[14px] lg:px-[30px] rounded-[10px] lg:rounded-[20px]"
                    >
                        <span className="text-[12px] md:text-[16px] lg:text-[20px] xl:text-[24px]">Рассчитать</span>
                        <img src={calculator} alt="" />
                    </a>
                    <a
                        className="flex justify-center items-center gap-[8px] bg-[#E9EBEE66] hover:bg-[#506fa1] active:bg-white border-[1px] md:border-[2px] border-[#28282B] active:text-[#344E74] text-[#28282B] py-[8px] md:py-[10.5px] lg:py-[18px] px-[14px] lg:px-[30px] rounded-[10px] lg:rounded-[20px]"
                    >
