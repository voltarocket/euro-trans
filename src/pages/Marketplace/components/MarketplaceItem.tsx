...
const MarketplaceItem:React.FC = () => {
    return (
        <div className="flex flex-col justify-center items-center bg-[#E9EBEE] rounded-[20px] py-[32px] lg:py-[64px] px-[20px] md:px-[41px] lg:px-[60px] -mt-[20px] relative">
             ...
             <p className="text-[14px] md:text-[22px] lg:text-[26px] xl:text-[38px] text-center mb-[31px]">Работаем по схеме FBO</p>
            <div className="flex flex-col md:flex-row gap-[28px] md:gap-[21px] justify-center items-center">
             <img
                className="hover:scale-110 transition-all transform-gpu h-[60px]" 
                src={wildberries}
                alt=""
             />
             <img
             ...
             />
             <img 
                className="hover:scale-110 transition-all transform-gpu h-[48px]"
                src={yandexmarket} 
                alt="" 
             />
         </div>
