...
const Footer: React.FC = () => {
    return (
        <div className="lg:pr-[31px] lg:pl-[460px] xl:pl-[595px] pt-6 lg:pt-[32px] bg-[#E9EBEE] rounded-t-[20px] border-t-[3px] border-l-[3px] border-r-[3px] border-[#344E74] text-lg lg:text-[32px] pb-[100px] lg:pb-[87px]">
